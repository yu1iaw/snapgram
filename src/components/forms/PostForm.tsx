        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl">
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    ...
                                    placeholder="JS, React, React Native, NextJS"
                                    {...field}
                                />
                            </FormControl>
                            <FormMessage className="shad-form_message" />
                ...
                <div className="flex gap-4 items-center justify-end">
                    <Button onClick={() => navigate(-1)} type="button" className="shad-button_dark_4">Cancel</Button>
                    <Button
                        type="submit"
                    ...
                    >
                        {isLoadingCreate || isLoadingUpdate ? <Loader /> : (
                            `${action.at(0)?.toUpperCase() + action.slice(1)} Post`
                        )}
                    </Button>
                </div>
            </form>
